...
function RaisingComplaints() {
  ...
  <form onSubmit={submitHandler} className="h-screen w-screen flex flex-wrap justify-center items-center">
    ...
    <div className="card overflow-hidden px-10 py-10 max-w-3xl mx-auto" style={{ width: '600px' }}>
        ...
        <button className="my-4 px-8 py-2 mx-auto block rounded-md text-lg font-semibold text-white hover:bg-white hover:text-blue-500 border-2 border-blue-500 transition-all duration-200 bg-blue-500">
          Add Complaint
        </button>
      </div>
    </div>
